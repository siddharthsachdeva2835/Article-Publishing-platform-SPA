...
@Component({
  selector: 'app-favaricles',
  templateUrl: './favaricles.component.html',
  styleUrls: ['./favaricles.component.css']
})
export class FavariclesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.articleService.getFavArticles(this.activatedRoute.snapshot.paramMap.get('username')).subscribe(art => {
      this.articles = art;
